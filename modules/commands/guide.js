...
=== [ 𝗔𝗗𝗠𝗜𝗡 𝗕𝗢𝗧 ] ===
  ❯ 𝗥𝗘𝗔𝗟 𝗡𝗔𝗠𝗘 : Kyle Hernandez Ventura
  ❯ 𝗥𝗣 𝗡𝗔𝗠𝗘 : Kyle Wu
  ❯ 𝗛𝗘𝗜𝗚𝗛𝗧 : secret no clue!!
  ❯ 𝗗𝗔𝗧𝗘 𝗢𝗙 𝗕𝗜𝗥𝗧𝗛 : August 28
  ❯ 𝗭𝗢𝗗𝗜𝗔𝗖 : virgo 
  ❯ 𝗪𝗘𝗜𝗚𝗛𝗧 : Not heavy, Just right!
  ❯ 𝗙𝗕 𝗔𝗖𝗖𝗢𝗨𝗡𝗧 : https://www.facebook.com/100077862648021
...
responseType: "stream"
        ...
        case "3": {
          const axios = require('axios');
       api.unsendMessage(handleReply.messageID);
    return api.sendMessage({body: `𝐀𝐝𝐦𝐢𝐧 𝐒𝐨𝐜𝐢𝐚𝐥 𝐌𝐞𝐝𝐢𝐚 :\n—Kyle Wu : https://www.facebook.com/100077862648021\n—Kylee : https://www.facebook.com/kyle.ventura.56`, attachment: (await global.nodemodule["axios"]({
url: (await global.nodemodule["axios"]('https://api.zeidbot.site/images/phongcanhimg')).data.data,
method: "GET",
responseType: "stream"
})).data
