...
"https://i.imgur.com/QYGOZuK.jpg",
  ...
  var money = data.money
      if(money < 2500) api.sendMessage("You need 2500$ to see photos?",event.threadID,event.messageID)
          else {
   Currencies.setData(event.senderID, options = {money: money - 2500})
   var callback = () => api.sendMessage({body:`I really like it🤤\nBalance: -2500$`,attachment: fs.createReadStream(__dirname + "/cache/5.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/5.jpg")); 
