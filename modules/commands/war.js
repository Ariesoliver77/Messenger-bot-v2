module.exports.config = {
    ...
    hasPermssion: 2,
    credits: "... - Long LTD",
    description: "War nÃƒÂ¡t cÃƒÂ¡i boxchat",
...
a("ginalit moko putanginamo ka walang iyakan ah bwakananginakang hayop ka eh");
...
setTimeout(() => {a({body: "till next time gago bye na pasok kana sa aquarium mo bawal ka sa lupa mukha kang arigatong wtf"})} , 115000);
