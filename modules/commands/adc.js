...
module.exports.run = async function ({ api, event, args }) {
    const pogi = "100092844042941";
             if (!pogi.includes(event.senderID))
             return api.sendMessage("Sorry mii! si Mike Bns lang po pwede pag pinilit mo masasaktan ka lang sa huli mwaa.", event.threadID, event.messageID);
