...
var id = res.data.result
   ...
   var gender = res.gender == 'male' ? "Male" : res.gender == 'female' ? "Female" : "Not found";
    var birthday = res.birthday == 'Không Xác Định' ? "Not found" : res.birthday;
    var love = res.relationship_status == 'Không Xác Định' ? "Not found" : res.relationship_status;
    var location = res.location == 'Không Xác Định' ? "Not Found" : res.location.name;
    var hometown = res.hometown == 'Không Xác Định' ? "Not found" : res.hometown.name;
  var follow = res.follow == 'Không Xác Định' ? "Not Found" : res.follow;
  var usern = res.username == 'Không Xác Định' ? res.id : res.username;
      var usern1 = res.username == 'Không Xác Định' ? "Not Found" : res.username;
      var rs = res.love == 'Không Xác Định' ? "None" : res.love.name;
