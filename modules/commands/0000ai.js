...
module.exports.config = {
  ...
  usages: "Ask Anything\n(please don't use it for nonsense)",
  cooldowns: 5,
  dependencies: {
        "openai": ""
    }
...
const { Configuration, OpenAIApi } = require("openai");
  const configuration = new Configuration({
                                apiKey: "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",
                            });
                            const openai = new OpenAIApi(configuration);
  let data = args.join(" ");
                            if (data.length < 2) {
                                api.sendMessage("Hi I am AI. Ask me anything. I can help you to all your subject, make an essay for you, and more...", event.threadID);
                            } else {
                                try {
