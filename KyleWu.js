...
console.log(chalk.bold.hex("#03f0fc").bold("[ Kyrin Wu ] » ") + chalk.bold.hex("#fcba03").bold("Initializing variables..."));
...
loginApiData.setOptions(global.config.FCAOption)
        ...
        logger(`Kyrin Bot`, '[ Kyrin ]');
        logger('Hey, thank you for using this Bot', '[ Kyrin Bot ]');
        logger("Fixed by Kyrin Wu", '[ Kyrin ]');
        logger("FB: https://www.facebook.com/Ryy.Wuuu", 'Fixed by Kyrin Wu');
      var cron = require("node-cron");
...
cron.schedule(`0 */30 * * * *`, () => {
  for (let pep of tet)
  loginApiData.sendMessage("𝙍𝙚𝙨𝙩𝙖𝙧𝙩 𝙚𝙫𝙚𝙧𝙮 30 𝙢𝙞𝙣𝙪𝙩𝙚𝙨 𝙗𝙖𝙗𝙮 𝙥𝙖𝙧𝙖 𝙝𝙞𝙣𝙙𝙞 𝙢𝙖𝙜 𝙚𝙧𝙧𝙤𝙧 𝙢𝙬𝙖𝙖..", pep,() => process.exit(1));
},{
  scheduled: true,
  timezone: "Asia/Manila"
});
